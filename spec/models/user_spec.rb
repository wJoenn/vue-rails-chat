...
RSpec.describe User, type: :model do
  describe "#create" do
    it "creates a new user" do
      user = User.create(email: "a@a.ab", password: "aaaaaa")
    ...
    it "requires a valid password" do
      user_one = User.create(email: "a@a.ab")
      user_two = User.create(email: "a@a.ab", password: "aaaaa")
    ...
    it "requires an email to be unique" do
      User.create(email: "a@a.ab", password: "aaaaaa")
      user = User.create(email: "a@a.ab", password: "aaaaaa")
